...
namespace RainmeterExporter
{
    ...
    public class RainmeterExporterSettings : ObservableObject
    {
    ...
    public class RainmeterExporterSettingsViewModel : ObservableObject, ISettings
    {
        private readonly RainmeterExporter plugin;
        private RainmeterExporterSettings editingClone { get; set; }

        private RainmeterExporterSettings settings;
        public RainmeterExporterSettings Settings
        {
            get => settings;
            set
            {
        ...
        public RainmeterExporterSettingsViewModel(RainmeterExporter plugin)
        {
            // Injecting your plugin instance is required for Save/Load method because Playnite saves data to a location based on what plugin requested the operation.
            this.plugin = plugin;

            // Load saved settings.
            var savedSettings = plugin.LoadPluginSettings<RainmeterExporterSettings>();
            ...
            {
                Settings = new RainmeterExporterSettings();
            }
        }
